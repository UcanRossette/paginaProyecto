            ...
            /* Palabras */
            palabras_array.push("BAKHALAL");
            palabras_array.push("CHETUMAL");
            ...
            function pistaFunction(palabra){
                ...
                switch(palabra){  // Se crea un switch para poder controlar las pistas segun la palabra 
                    case 'BAKHALAL':   // Se debera hacer un case por cada palabra 
                        pista = "Pista: Bacalar en maya";
                        break;     // Es importante el break en cada case 
                    case 'CHETUMAL':
                        pista = "Capital del estado de Quintana Roo";
                        break;
                    case 'PERRO':
